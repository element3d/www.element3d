...
export function Text() {
  return (
    <div className="d-flex fd-col ai-start">
      <h1 className="color-main">Text</h1>
      <p>An element for displaying a text. By default, text element automaticaly calculates the size of the content if no sizing property is set.</p>

      <div className="d-flex">
        <div className="e3-code">
          <div className="half-width">
            <span className="e3-xml-color">{"<Text"}</span>
